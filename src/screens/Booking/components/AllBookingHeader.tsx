...
const HERO_ILLUSTRATION = {
  uri: 'https://d2f15ematxpwp4.cloudfront.net/appImages/bookingbg.png',
};

export const AllBookingHeader: React.FC<Props> = ({
  title = 'My Bookings',
  ...
  return (
    ...
    >
      ...
      {headerSize.width > 0 && headerSize.height > 0 ? (
        ...
        >
          <Defs>
            <LinearGradient id="allBookingHeaderGrad" x1="0" y1="0" x2="0.3" y2="1">
      ...
      {/* Hero content: text on left, bookingbg illustration on right */}
      <View style={styles.heroContentRow}>
        ...
        <Image
          ...
          resizeMode="contain"
          accessible
          accessibilityLabel="All bookings header illustration"
        />
      </View>
    </View>
  );
...
export default React.memo(AllBookingHeader);
